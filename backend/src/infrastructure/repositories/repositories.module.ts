...
import { STOCK_MOVEMENT_REPOSITORY } from '../../domain/ports/outbound/stock-movement-repository.port';
...
import { UNIT_OF_WORK } from '../../domain/ports/outbound/unit-of-work.port';
...
/**
 * Módulo que enlaza cada puerto de salida (repositorios, generador de ids,
 * unidad de trabajo) con su implementación concreta y las exporta.
 *
